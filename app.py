...
client = Groq("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")
...
def chat():
    try:
        ...
        # 'response' नाम से ही डाटा भेज रहे हैं जैसा तुम्हारे ओरिजिनल कोड में था
...
# Render के लिए पोर्ट फिक्स (जरूरी)
